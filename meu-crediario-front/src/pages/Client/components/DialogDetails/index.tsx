...
export const DialogDetails: FC<{ onClose: () => void; open: boolean; quotaData: IQuota[] }> = ({
  ...
  return (
    <DialogContainer
      ...
      isXl={true}
    >
      <StyledDialogContainer data-testid="dialog-details">
        {quotaData?.map((item, index) => (
          <StyledContainer key={index}>
            ...
            <StyledTextContainer>
              ...
              <StyledText>{formatToLocalDate(item.datavencimento)}</StyledText>
            </StyledTextContainer>
            <StyledTextContainer>
              <StyledText>Valor do vencimento: </StyledText>
              <StyledText>{formatMoneyValue(item.valorvencimento)}</StyledText>
            </StyledTextContainer>
            <StyledTextContainer>
              <StyledText>Total pago: </StyledText>
              <StyledText>{formatMoneyValue(item.totalpago)}</StyledText>
            </StyledTextContainer>
            <StyledTextContainer>
              <StyledText>Capital aberto: </StyledText>
              <StyledText>{formatMoneyValue(item.capitalaberto)}</StyledText>
            </StyledTextContainer>
          </StyledContainer>
        ))}
      </StyledDialogContainer>
